...
class SignupViewModelTest {
    ...
    @Test
    fun `first name change`() {
        val vm = testSignupViewModel()
        vm.onFirstNameChange(name = "NewName")
        val state = vm.uiState.value
        assertEquals("NewName", state.firstName)
    }

    @Test
    fun `last name change`() {
        val vm = testSignupViewModel()
        vm.onLastNameChange(name = "Smith")
        val state = vm.uiState.value
